...
if ($key = param('key')){
	...
	<?php
	foreach ($processes as $id => $process){ $project = $projects[$process->project_id]; ?>
	...
	<?php
	foreach ($terminals as $tid => $terminal){
	...
	<?php
	foreach ($connectors as $cid => $connector){
	...
	<?php
	foreach ($diagrams as $did => $diagram){
