...
$translations = array(
		...
		'Amount'=>'Menge',
		'Are you shure you want to delete ◊ ◊?'=>'Sind Sie sicher, dass Sie ◊ ◊ löschen möchten?',
		...
		'Date'=>'Datum',
		'Dates'=>'Daten',
		"Dear Ladies and Gentlemen,\n\nAttached to this mail you will find a new ◊ document. To open it, you need a pdf viewer."=>"Werte Damen und Herren,\n\nim Anhang dieser Mail befindet sich ein neues ◊s-Dokument. Sie benötigen einen PDF-Reader um es zu öffnen.",
		...
		'Enter a new footer, please.' => 'Bitte neuen Fußtext eingeben.',
		'Enter a new header, please.' => 'Bitte neuen Kopftext eingeben.',
		'error'=>'Fehler',
		...
		'This ◊ can not be deleted!' => 'Diese ◊ kann nicht gelöscht werden!',
