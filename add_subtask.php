...
if ($name){
	if (is_array($user_ids) && !empty($user_ids)){
		add_task($name,$description,$project_id,$parent_task_id, post('start_date'), post('due_date'),$user_ids);
...
<form method="POST">
	<fieldset>
		<legend><?= t('Add subtask to "?"',$task['name']) ?></legend>
		...
		<fieldset><legend><?= t('Users') ?></legend>
