...
expectJson(r,'{"1": {"id": 1, "login": "admin", "email": "user1@example.com", "settings": null}, "3": {"id": 3, "login": "user3", "email": null, "settings": null}, "2": {"id": 2, "login": "user2", "email": "user2@example.com", "settings": null}}')
r = admin_session.get('http://localhost/user/1/json',allow_redirects=False)
expectJson(r,'{"id":1,"login":"admin","email":"user1@example.com","settings":null}')

r = admin_session.get('http://localhost/user/2/json',allow_redirects=False)
expectJson(r,'{"id":2,"login":"user2","email":"user2@example.com","settings":null}')
...
expectJson(r,'{"1":{"id":1,"login":"admin","email":"user1@example.com","settings":null},"2":{"id":2,"login":"user2","email":"user2@example.com","settings":null}}')
