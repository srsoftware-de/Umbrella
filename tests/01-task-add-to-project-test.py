...
expect(r,'<input type="radio" name="users[1]" title="verantwortlich" value="3" checked="checked" /></td>')
...
expect(r,'<input type="radio" name="users[2]" title="verantwortlich" value="3" /></td>')
